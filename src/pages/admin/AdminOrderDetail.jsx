...
const AdminOrderDetail = () => {
    ...
    const handleProcessOrder = async () => {
        if (
            !confirm(
                "Apakah Anda yakin ingin memproses pesanan ini menjadi status Dikirim?"
            )
        ) {
            return;
        }
        ...
        try {
            ...
            const response = await updateOrderStatusUserAdmin(id, "dikirim");
            ...
            alert("Pesanan berhasil diproses dan status diubah menjadi Dikirim!");
                        ...
                        {steps.map((step, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span
                                        className={`text-xs mt-2 ${isActive ? "text-[#006850] font-medium" : "text-gray-500"
                                            }`}
                                    >
                                        {step.label}
                                    </span>
