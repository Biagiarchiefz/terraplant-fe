      ...
      <>
        <td className="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap">
          <div className="flex items-center gap-2 md:gap-3">
            <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-[#047158] flex items-center justify-center text-white font-bold text-xs md:text-sm flex-shrink-0">
        ...
        <td className="px-3 md:px-6 py-3 md:py-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs md:text-sm text-gray-900 truncate max-w-[150px] md:max-w-none">
              {user.email}
            </span>
          </div>
        </td>
        <td className="px-3 md:px-6 py-3 md:py-4">
          <span className="text-xs md:text-sm text-gray-500 line-clamp-2 md:line-clamp-1">
            {user.alamat || "-"}
          </span>
        </td>
        <td className="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap">
